...
<head>
    <meta charset="utf-8">
    <title>Booking Events - MosqueCONNECT</title>
...
<body>
            ...
            <div class="row">
                <div class="col-lg-7">
                    <div class="hero-header-inner animated zoomIn">
                        <h1 class="display-1 text-dark">Join an Event!</h1>
                        <ol class="breadcrumb mb-0">
                            <li class="breadcrumb-item"><a href="home.html">Home</a></li>
                            <li class="breadcrumb-item"><a href="#">Pages</a></li>
                            <li class="breadcrumb-item text-dark" aria-current="page">Booking Events</li>
                        </ol>
                    </div>
                </div>
            </div>
    ...
    <div class="reservation-container">
        <h2 class="text-center mb-4">Reserve Your Spot for Events</h2>
        <form action="process_event_booking.php" method="POST">
                ...
                <select class="form-select" id="event" name="EventID" required>
                    ...
                    if ($result->num_rows > 0) {
                        while ($row = $result->fetch_assoc()) {
                            echo "<option value='{$row['EventID']}'>{$row['EventName']} - {$row['EventDateTime']}</option>";
                        }
                    }
                    $conn->close();
                    ?>
